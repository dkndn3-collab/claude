 ...
 *
 * Both builders use it: the component builder in app.js and the gradient
 * builder in gradient.js. A definition is the same shape everywhere —
 * `{ key, label, type, min, max, step, unit, options, placeholder }` — and the
